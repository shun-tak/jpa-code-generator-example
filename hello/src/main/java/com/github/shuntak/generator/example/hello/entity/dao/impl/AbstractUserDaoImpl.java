...
/** User DAO base class. Auto generated by JPA code generator. */
@Generated(value = "JPACodeGenerator")
public abstract class AbstractUserDaoImpl extends AbstractDaoImpl<User>
  ...
  @Override
  public User persist(String name) {
    User user = User
        .builder()
        .name(name)
        .build();
